...
const HireTalent = () => {
    ...
    const TeamArray = [
        { name: 'Topobar Layek', title: 'UI/UX Designing', avatar: 'https://i.insider.com/5899ffcf6e09a897008b5c04?width=1000&format=jpeg&auto=webp', image: UIUX, likes: '4.5k', views: '109' },
        { name: 'Mason Jane', title: 'Graphics Designing', avatar: 'https://qph.cf2.quoracdn.net/main-thumb-3480496-200-BIsjU5IOTadRDrAft68o8zAKNaVvy2aJ.jpeg', image: Graphics, likes: '4.5k', views: '109' },
        { name: 'Jason Roy', title: 'Content Writing', avatar: 'https://media.licdn.com/dms/image/D5603AQGhcsnpTwI1xA/profile-displayphoto-shrink_400_400/0/1678074582126?e=1692230400&v=beta&t=FLD-3eTptRyxyOf60yrO6pyvIlJjh-XOGPtPOAEgBcU', image: Content, likes: '4.5k', views: '109' },
        ...
        { name: 'Mason Jane', title: 'Blockchain', avatar: 'https://images.squarespace-cdn.com/content/v1/5aee389b3c3a531e6245ae76/1527417334547-B9VIPPG61XQYM2RZ08U2/DBS_George_Sampford.jpg?format=1000w', image: Blockchain, likes: '4.5k', views: '109' },
        { name: 'Pat Stewert', title: 'App Development', avatar: avatar, image: App, likes: '4.5k', views: '109' }
    ]
