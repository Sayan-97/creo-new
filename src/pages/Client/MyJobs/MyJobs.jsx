...
import { AllJobPosts, InvitedFreelancers, MyHires, Saved } from './components';

const MyJobs = () => {

    const jobsArray = ['All Job Posts', 'Invited Freelancers', 'My Hires', 'Saved'];

    const [selectedView, _selectedView] = useState('All Job Posts');
