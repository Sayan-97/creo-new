...
import { AllProposals, Shortlisted, Messaged, Archived } from './components'

const MyProposals = () => {

    const propArray = ['All Proposals', 'Shortlisted', 'Messaged', 'Archived'];

    const [selectedView, _selectedView] = useState('All Proposals');
                ...
                <div className='w-full h-full bg-gradient-to-b from-[#171717] to-transparent rounded-2xl p-0.5'>
                    <div className='w-full h-full bg-[#171717] grid grid-cols-12 rounded-2xl'>
                        ...
                        <div className='col-span-12 lg:col-span-9'>
                            {
                                selectedView === 'All Proposals'
                                    ? <AllProposals />
                                    : selectedView === 'Shortlisted'
                                        ? <Shortlisted />
                                        : selectedView === 'Messaged'
                                            ? <Messaged />
