...
import Shortlist from '../../../../assets/images/pages/shortlist.png'
  ...
  return (
    <div className='py-8 px-4'>
      ...
      <div className='grid justify-items-center py-8 space-y-8'>
        <img src={Shortlist} alt="img" />
        <h5>You have no shortlisted proposals</h5>
        <p>Use the shortlist feature to add your preferred proposals.</p>
      </div>
    </div>
  )
}
