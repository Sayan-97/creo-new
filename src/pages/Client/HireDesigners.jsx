...
import Creative from '../../assets/images/pages/creativedesigners.png'
    ...
    return (
        <div className='container space-y-16'>
            <div className='bg-accent py-12 rounded-card relative'>
                ...
                <img src={Creative} alt="img" className='absolute rounded-r-card top-0 right-0 h-full w-[40%]'/>
            ...
            <div className='space-y-8'>
                <h4>Top Rated UI/UX Designers</h4>
                <div className='grid md:grid-cols-2 lg:grid-cols-4 gap-4'>
                    {UIDesigners.map((item, index) => {
                        return (
                            <div key={index} className='flex flex-col'>
                                <img src={item.imgSrc} alt="img" className='rounded-t-card' />
                                <div className='bg-accent py-4 px-4 rounded-b-card space-y-4'>
